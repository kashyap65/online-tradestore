...
public class TradeModel {
	...
	public TradeModel(String tradeId, int version, String counterPartyId, String bookId, Date maturityDate,
			Date createdDate, String expiredFlag) {
		super();
	...
	public String toString() {
		return "TradeModel [tradeId=" + tradeId + ", version=" + version + ", counterPartyId=" + counterPartyId
